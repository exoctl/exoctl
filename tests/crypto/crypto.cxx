...
TEST_F(CryptoTest, ShaGenEmptyString)
{
    ...
    const std::string hash_sha256 = sha->sha_gen_sha256_hash(empty_string);
    const std::string hash_sha3_256 = sha->sha_gen_sha3_256_hash(empty_string);
    const std::string hash_sha512 = sha->sha_gen_sha512_hash(empty_string);
...
TEST_F(CryptoTest, ShaGenDifferentStrings)
{
    ...
    const std::string hash1 = sha->sha_gen_sha256_hash(string1);
    const std::string hash2 = sha->sha_gen_sha256_hash(string2);
...
TEST_F(CryptoTest, ShaGenSpecialCharacters)
{
    ...
    const std::string hash = sha->sha_gen_sha256_hash(special_string);
