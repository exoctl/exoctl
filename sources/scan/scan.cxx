...
namespace Analysis
{
    ...
    const void Scan::scan_bytes(const std::string p_buffer, const std::function<void(void *)> &p_callback) const
    {
        DTOAnalysis *analysis = new DTOAnalysis;

        m_yara.syara_scan_bytes(p_buffer, [&](void *yr_user_data)
        {
            analysis->is_malicious = ((Analysis::yr_user_data *)yr_user_data)->is_malicius;
