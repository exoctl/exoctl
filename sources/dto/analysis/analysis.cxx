...
const std::string &DTOAnalysis::dto_get_yrule() const { return m_yrule; }
...
void DTOAnalysis::dto_set_yrule(const std::string &p_yrule)
{
    m_yrule = p_yrule;
}
...
DTOAnalysis::DTOAnalysis(scan_t p_malicious,
                         ...
                         bool p_is_packed,
                         std::string p_packed)
    : m_is_malicious(p_malicious), m_yrule(std::move(p_rule)),
