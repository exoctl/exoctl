...
namespace engine::bridge::endpoints::analysis
{
    void Records::setup(Analysis &analysis)
    {
        ...
        analysis.map_.add_route("/record", [&]() {
            auto web_record_ = std::make_unique<server::gateway::web::Web>();
            web_record_->setup(
                &*analysis.server_,
                BASE_ANALYSIS "/record",
                [&](const crow::request &req) -> const crow::response {
                    if (req.method != crow::HTTPMethod::GET) {
                        const auto method_not_allowed =
                            server::gateway::responses::MethodNotAllowed();
                    ...
                    record_anal.add("id", anal.id);
                    record_anal.add("file_name", anal.file_name);
                    record_anal.add("file_type", anal.file_type);
                    record_anal.add("sha256", anal.sha256);
                    record_anal.add("sha1", anal.sha1);
                    record_anal.add("sha512", anal.sha512);
                    record_anal.add("sha224", anal.sha224);
                    record_anal.add("sha384", anal.sha384);
                    record_anal.add("sha3_256", anal.sha3_256);
                    record_anal.add("sha3_512", anal.sha3_512);
                    record_anal.add("file_size", anal.file_size);
                    record_anal.add("file_entropy", anal.file_entropy);
                    record_anal.add("creation_date", anal.creation_date);
                    record_anal.add("last_update_date", anal.last_update_date);
                    record_anal.add("file_path", anal.file_path);
                    record_anal.add("is_malicious", anal.is_malicious);
                    record_anal.add("is_packed", anal.is_packed);
                    record_anal.add("family_id", anal.family_id);
                    record_anal.add("description", anal.description);
                    record_anal.add("owner", anal.owner);
                    record_anal.add("tlsh", anal.tlsh);
                    ...
                    record_anal.add("family", family_json);
                    ...
                    record_anal.add("tags", tags_json);
