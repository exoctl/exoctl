        ...
        class WebSocket
        {
          public:
            using on_error_callback =
                std::function<void(bridge::websocket::Context &,
                                   crow::websocket::connection &,
                                   const std::string &)>;
            using on_accept_callback = std::function<void(
                bridge::websocket::Context &, const crow::request &, void **)>;
            using on_open_callback = std::function<void(
                bridge::websocket::Context &, crow::websocket::connection &)>;
          ...
          private:
            CrowApp &m_crow;
            std::string m_url;
            bridge::websocket::Context m_context;
            std::mutex m_mtx;
